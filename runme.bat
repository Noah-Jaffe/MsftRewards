@echo off
set /A mobile_points=100*1.5
set /A desktop_points=150*1.5
...
echo %points_per_search% points per search
echo get %mobile_points% points from mobile using the header %mobile_user_agent%
...
start msedge --new-window --disable-application-cache --user-agent=%mobile_user_agent% %urllist%
...
start msedge --new-window --disable-application-cache --user-agent=%desktop_edge_user_agent% %urllist% 
